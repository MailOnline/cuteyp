    ...
    subscriber.on('message', function (error, message) {
        ...
        var res = new Response(req, {
            endFn: function (body, encoding) {
                ...
                var headers = _.extend({}, res._headers);
                if (body) _.extend( headers, { 'content-length': body.length });
                ...
                console.log( res.statusCode, parsed.url, replyTo, outgoingResponse.headers.location, outgoingResponse.headers['content-length'],  body && body.substring(0,50));
