...
function fromHttp(app, queueImpl, opts, ttl) {
    ...
    subscriber.on('message', function (error, message) {
            ...
            if (parsed.first) {
                ...
                //console.log(parsed.code, req.url, continuation.bodyLength, correlationId, bodyString);
                continuation.body = httpBody.substring(0, 100);
                ...
                //var length = Buffer.byteLength(httpBody);
                //console.log(parsed.code, req.url, by, correlationId, httpBody.substring(0, 100));
            ...
            if (parsed.end) {
                //var bodyString = continuation.body || httpBody;
                //var bodyLength = continuation.bodyLength || ;

                console.log(parsed.code, req.url, continuation.bodyLength, correlationId, continuation.body);

                //console.log("GOT END - deleting..");
